...
#define RXB_RX_ANY      0x60     //receive any message 
#define RXB_RX_EXT      0x40    // receive  message  that includes extend identifier of meeting the requirements for the filter  
#define RXB_RX_STD      0x20    // receive  message  that includes standard  identifier of meeting the requirements for the filter
#define RXB_RX_STDEXT   0x00    //receive any message  that  meet the requirements for the filter of standard or extend
...
typedef struct{
       ...
       unsigned int  Throttle_ID;
       unsigned char CAN_bandrate;
       unsigned char CAN_IsExt;
       unsigned char RPM_Byte;      
       unsigned char RPM_endian;
       unsigned char SPEED_Byte;
       unsigned char SPEED_endian;    
       unsigned char Throttle_Byte;
       unsigned char Throttle_endian; 
